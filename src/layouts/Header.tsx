...
export function Header() {
  ...
  const { notificationCount, messageCount, toggleMobileSidebar } = useUIStore();
  ...
  return (
    <header className="flex h-14 shrink-0 items-center gap-4 border-b border-[#2e2e2e] bg-[#111111]/80 px-4 backdrop-blur-sm">
      ...
      <button
        ...
        className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-[#6b6b6b] transition-colors hover:bg-[#1a1a1a] hover:text-[#f5f5f5] sm:hidden"
      >
