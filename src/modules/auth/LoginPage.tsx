  ...
  return (
    <div>
      <div className="mb-6 text-center">
        <h1 className="text-xl font-bold text-[#f5f5f5]">Welcome back</h1>
        <p className="mt-1 text-sm text-[#6b6b6b]">Sign in to your CodeNest account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <div className="flex justify-end">
          <Link to="/forgot-password" className="text-xs text-[#6b6b6b] hover:text-[#a3a3a3]">
            Forgot password?
          </Link>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-[#6b6b6b]">
        No account?{" "}
        <Link to="/register" className="font-medium text-[#f5f5f5] hover:underline">
          Sign up
        </Link>
      </p>
    </div>
